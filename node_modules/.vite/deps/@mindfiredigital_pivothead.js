import {
  E
} from "./chunk-B5QMO4KJ.js";
import "./chunk-D7ZASVPN.js";
import {
  __commonJS
} from "./chunk-7D4SUZUM.js";

// optional-peer-dep:__vite-optional-peer-dep:winston:@mindfiredigital/pivothead:true
var require_pivothead_true = __commonJS({
  "optional-peer-dep:__vite-optional-peer-dep:winston:@mindfiredigital/pivothead:true"(exports, module) {
    module.exports = {};
    throw new Error(`Could not resolve "winston" imported by "@mindfiredigital/pivothead". Is it installed?`);
  }
});
...
function SSF_general_num(v) {
  var V2 = Math.floor(Math.log(Math.abs(v)) * Math.LOG10E), o;
  if (V2 >= -4 && V2 <= -1) o = v.toPrecision(10 + V2);
  else if (Math.abs(V2) <= 9) o = SSF_small_exp(v);
...
function commaify(s) {
  ...
  var j2 = s.length % w, o = s.substr(0, j2);
  for (; j2 != s.length; j2 += w) o += (o.length > 0 ? "," : "") + s.substr(j2, w);
  return o;
}
var pct1 = /%/g;
...
function write_num_exp(fmt, val) {
  ...
  if (fmt.match(/^#+0.0E\+0$/)) {
    ...
    var ee3 = Math.floor(Math.log(val) * Math.LOG10E) % period;
    if (ee3 < 0) ee3 += period;
    o = (val / Math.pow(10, ee3)).toPrecision(idx + 1 + (period + ee3) % period);
    if (o.indexOf("e") === -1) {
      var fakee = Math.floor(Math.log(val) * Math.LOG10E);
      if (o.indexOf(".") === -1) o = o.charAt(0) + "." + o.substr(1) + "E+" + (fakee - o.length + ee3);
      else o += "E+" + (fakee - ee3);
    ...
    o = o.replace(/^([+-]?)(\d*)\.(\d*)[Ee]/, function($$, $1, $22, $3) {
      return $1 + $22 + $3.substr(0, (period + ee3) % period) + "." + $3.substr(ee3) + "E";
    });
...
function SSF_split_fmt(fmt) {
  var out = [];
  var in_str = false;
  for (var i = 0, j2 = 0; i < fmt.length; ++i) switch (
    /*cc=*/
    fmt.charCodeAt(i)
  ) {
    case 34:
    ...
    case 92:
      ...
      break;
    case 59:
      out[out.length] = fmt.substr(j2, i - j2);
      j2 = i + 1;
  }
...
function eval_fmt(fmt, v, opts, flen) {
  var out = [], o = "", i = 0, c = "", lst = "t", dt, j2, cc;
  var hr = "H";
  while (i < fmt.length) {
    switch (c = fmt.charAt(i)) {
      case "G":
  ...
  if (nstr.length > 0) {
    ...
    if (decpt === out.length && ostr.indexOf("E") === -1) {
      ...
      for (i = decpt; i >= 0; --i) {
        if (out[i] == null || "n?".indexOf(out[i].t) === -1) continue;
        j2 = out[i].v.indexOf(".") > -1 && i === decpt ? out[i].v.indexOf(".") - 1 : out[i].v.length - 1;
        vv = out[i].v.substr(j2 + 1);
        for (; j2 >= 0; --j2) {
          if (jj >= 0 && (out[i].v.charAt(j2) === "0" || out[i].v.charAt(j2) === "#")) vv = ostr.charAt(jj--) + vv;
        }
        out[i].v = vv;
        out[i].t = "t";
        lasti = i;
      ...
      for (i = decpt; i < out.length; ++i) {
        ...
        j2 = out[i].v.indexOf(".") > -1 && i === decpt ? out[i].v.indexOf(".") + 1 : 0;
        vv = out[i].v.substr(0, j2);
        for (; j2 < out[i].v.length; ++j2) {
...
function dateNF_fix(str, dateNF, match) {
  var Y2 = -1, m = -1, d = -1, H2 = -1, M3 = -1, S = -1;
  ...
  var timestr = ("00" + (H2 >= 0 ? H2 : 0)).slice(-2) + ":" + ("00" + (M3 >= 0 ? M3 : 0)).slice(-2) + ":" + ("00" + (S >= 0 ? S : 0)).slice(-2);
  if (H2 == -1 && M3 == -1 && S == -1) return datestr;
...
var CRC32 = (function() {
  ...
  function slice_by_16_tables(T10) {
    ...
    for (n = 0; n != 256; ++n) {
      v = T10[n];
      for (c = 256 + n; c < 4096; c += 256) v = table[c] = v >>> 8 ^ T10[v & 255];
    }
    var out = [];
  ...
  function crc32_buf(B2, seed) {
    var C = seed ^ -1, L = B2.length - 15, i = 0;
    for (; i < L; ) C = Tf[B2[i++] ^ C & 255] ^ Te2[B2[i++] ^ C >> 8 & 255] ^ Td[B2[i++] ^ C >> 16 & 255] ^ Tc[B2[i++] ^ C >>> 24] ^ Tb[B2[i++]] ^ Ta[B2[i++]] ^ T9[B2[i++]] ^ T8[B2[i++]] ^ T7[B2[i++]] ^ T6[B2[i++]] ^ T5[B2[i++]] ^ T4[B2[i++]] ^ T3[B2[i++]] ^ T2[B2[i++]] ^ T1[B2[i++]] ^ T0[B2[i++]];
    L += 15;
    while (i < L) C = C >>> 8 ^ T0[(C ^ B2[i++]) & 255];
    return ~C;
  }
...
var CFB = (function _CFB() {
  ...
  function build_full_paths(FI, FP, Paths) {
    var i2 = 0, L = 0, R = 0, C = 0, j2 = 0, pl = Paths.length;
    var dad = [], q3 = [];
    for (; i2 < pl; ++i2) {
      dad[i2] = q3[i2] = i2;
      FP[i2] = Paths[i2];
    ...
    for (; j2 < q3.length; ++j2) {
      ...
      if (L !== -1 && i2 != dad[i2]) {
        dad[L] = dad[i2];
        if (q3.lastIndexOf(L) < j2) q3.push(L);
      }
      if (R !== -1 && i2 != dad[i2]) {
        dad[R] = dad[i2];
  ...
  function _write(cfb, options) {
    ...
    if (L[1]) {
      for (T2 = 0; T2 < L[1]; ++T2) {
        for (; i2 < 236 + T2 * 127; ++i2) o.write_shift(-4, i2 < L[2] ? L[1] + i2 : -1);
        o.write_shift(-4, T2 === L[1] - 1 ? ENDOFCHAIN : T2 + 1);
      }
    }
    ...
    T2 = i2 = 0;
    for (T2 += L[1]; i2 < T2; ++i2) o.write_shift(-4, consts.DIFSECT);
    for (T2 += L[2]; i2 < T2; ++i2) o.write_shift(-4, consts.FATSECT);
    chainit(L[3]);
    chainit(L[4]);
    var j2 = 0, flen = 0;
  ...
  function realloc(b, sz) {
    var L = b.length, M3 = 2 * L > sz ? 2 * L : sz + 5, i2 = 0;
    if (L >= sz) return b;
    if (has_buf) {
      var o = new_unsafe_buf(M3);
      if (b.copy) b.copy(o);
      else for (; i2 < b.length; ++i2) o[i2] = b[i2];
      return o;
    } else if (use_typed_arrays) {
      var a = new Uint8Array(M3);
      if (a.set) a.set(b);
  ...
  function build_tree(clens, cmap, MAX) {
    var maxlen = 1, w = 0, i2 = 0, j2 = 0, ccode = 0, L = clens.length;
...
function evert_key(obj, key) {
  var o = [], K2 = keys(obj);
  for (var i = 0; i !== K2.length; ++i) if (o[obj[K2[i]][key]] == null) o[obj[K2[i]][key]] = K2[i];
  return o;
}
function evert(obj) {
  var o = [], K2 = keys(obj);
...
function parsexmltag(tag, skip_root, skip_LC) {
  ...
  var m = tag.match(attregexg), j2 = 0, v = "", i = 0, q2 = "", cc = "", quot = 1;
  if (m) for (i = 0; i != m.length; ++i) {
    ...
    if (j2 === q2.length) {
      ...
      z2[q2] = v;
      if (!skip_LC) z2[q2.toLowerCase()] = v;
    } else {
      var k = (j2 === 5 && q2.slice(0, 5) === "xmlns" ? "xmlns" : "") + q2.slice(j2 + 1);
      if (z2[k] && q2.slice(j2 - 3, j2) == "ext") continue;
      z2[k] = v;
      if (!skip_LC) z2[k.toLowerCase()] = v;
    }
  }
  return z2;
}
...
var unescapexml = /* @__PURE__ */ (function() {
  ...
  return function unescapexml2(text) {
    ...
    var j2 = s.indexOf("]]>");
    return unescapexml2(s.slice(0, i)) + s.slice(i + 9, j2) + unescapexml2(s.slice(j2 + 3));
  };
})();
var decregex = /[&<>'"]/g;
var charegex = /[\u0000-\u0008\u000b-\u001f]/g;
...
function utf8readb(data) {
  var out = new_raw_buf(2 * data.length), w, i, j2 = 1, k = 0, ww = 0, c;
  for (i = 0; i < data.length; i += j2) {
    j2 = 1;
...
var ___toBuffer = function(bufs) {
  var x = [], w = 10240;
  for (var i = 0; i < bufs[0].length; ++i) if (bufs[0][i]) for (var j2 = 0, L = bufs[0][i].length; j2 < L; j2 += w) x.push.apply(x, bufs[0][i].slice(j2, j2 + w));
  return x;
};
...
function write_ext_props(cp) {
  ...
  EXT_PROPS.forEach(function(f) {
    ...
    if (v !== void 0) o[o.length] = W2(f[0], v);
  });
  o[o.length] = W2("HeadingPairs", W2("vt:vector", W2("vt:variant", "<vt:lpstr>Worksheets</vt:lpstr>") + W2("vt:variant", W2("vt:i4", String(cp.Worksheets))), { size: 2, baseType: "variant" }));
  o[o.length] = W2("TitlesOfParts", W2("vt:vector", cp.SheetNames.map(function(s) {
...
function xlml_write_custprops(Props, Custprops) {
  ...
  return "<" + T2 + ' xmlns="' + XLMLNS.o + '">' + o.join("") + "</" + T2 + ">";
}
...
function writezeroes(n, o) {
  if (!o) o = new_buf(n);
  for (var j2 = 0; j2 < n; ++j2) o.write_shift(1, 0);
  return o;
}
...
function write_Hyperlink(hl) {
  ...
  if (F == 28) {
    ...
    for (i = 0; i < Target.length - 3 * P2; ++i) out.write_shift(1, Target.charCodeAt(i + 3 * P2) & 255);
    out.write_shift(1, 0);
...
function write_SST(sst, opts) {
  ...
  var strs2 = [];
  for (var j2 = 0; j2 < sst.length; ++j2) strs2[j2] = write_XLUnicodeRichExtendedString(sst[j2], opts);
...
function write_HLink(hl) {
  ...
  for (var i = 0; i < 16; ++i) O2.write_shift(1, parseInt(clsid[i], 16));
...
function write_HLinkTooltip(hl) {
  ...
  O2.write_shift(2, ref.c);
  O2.write_shift(2, ref.c);
  for (var i = 0; i < TT.length; ++i) O2.write_shift(2, TT.charCodeAt(i));
  O2.write_shift(2, 0);
  return O2;
}
  ...
  function sheet_to_dbf(ws, opts) {
    ...
    for (i = 0; i < headers.length; ++i) {
      ...
      if (headers.indexOf(headers[i]) !== i) {
        for (j2 = 0; j2 < 1024; ++j2)
          if (headers.indexOf(headers[i] + "_" + j2) == -1) {
            headers[i] += "_" + j2;
            break;
          }
      }
    ...
    for (i = 0; i <= range.e.c - range.s.c; ++i) {
      ...
      for (j2 = 0; j2 < data.length; ++j2) {
        if (data[j2][i] != null) col.push(data[j2][i]);
      }
    ...
    for (i = 0, j2 = 0; i < headers.length; ++i) {
      if (headers[i] == null) continue;
      var hf = ba.next(32);
      ...
      hf.write_shift(4, 0);
      hf.write_shift(4, 0);
      j2 += colwidths[i] || _RLEN[coltypes[i]] || 0;
    }
    var hb = ba.next(264);
    hb.write_shift(4, 13);
    ...
    for (i = 0; i < data.length; ++i) {
      ...
      for (j2 = 0; j2 < headers.length; ++j2) {
        ...
        switch (coltypes[j2]) {
          case "L":
            rout.write_shift(1, data[i][j2] == null ? 63 : data[i][j2] ? 84 : 70);
            break;
          case "B":
            rout.write_shift(8, data[i][j2] || 0, "f");
            break;
          case "N":
            var _n = "0";
            if (typeof data[i][j2] == "number") _n = data[i][j2].toFixed(coldecimals[j2] || 0);
            for (hcnt = 0; hcnt < colwidths[j2] - _n.length; ++hcnt) rout.write_shift(1, 32);
            rout.write_shift(1, _n, "sbcs");
            break;
          case "D":
            if (!data[i][j2]) rout.write_shift(8, "00000000", "sbcs");
            else {
              rout.write_shift(4, ("0000" + data[i][j2].getFullYear()).slice(-4), "sbcs");
              rout.write_shift(2, ("00" + (data[i][j2].getMonth() + 1)).slice(-2), "sbcs");
              rout.write_shift(2, ("00" + data[i][j2].getDate()).slice(-2), "sbcs");
            }
            break;
          case "C":
            var _s = String(data[i][j2] != null ? data[i][j2] : "").slice(0, colwidths[j2]);
        ...
        case "C":
          ...
          for (rj = 1; rj < record.length; ++rj) switch (record[rj].charAt(0)) {
            ...
            case "Y":
              ...
              if (!C_seen_X) C = 0;
              for (j2 = arr.length; j2 <= R; ++j2) arr[j2] = [];
              break;
            case "K":
...
function rgb2HSL(rgb) {
  var R = rgb[0] / 255, G2 = rgb[1] / 255, B2 = rgb[2] / 255;
  var M3 = Math.max(R, G2, B2), m = Math.min(R, G2, B2), C = M3 - m;
  if (C === 0) return [0, 0, R];
  var H6 = 0, S = 0, L2 = M3 + m;
  S = C / (L2 > 1 ? 2 - L2 : L2);
  switch (M3) {
    case R:
      H6 = ((G2 - B2) / C + 6) % 6;
...
function write_BrtFill(fill2, o) {
  ...
  if (fls != 40) {
    ...
    write_BrtColor({ auto: 1 }, o);
    for (; j2 < 12; ++j2) o.write_shift(4, 0);
  } else {
    for (; j2 < 4; ++j2) o.write_shift(4, 0);
    for (; j2 < 12; ++j2) o.write_shift(4, 0);
  }
  return o.length > o.l ? o.slice(0, o.l) : o;
}
...
function parse_PtgExtraArray(blob, length, opts) {
  ...
  for (var i = 0, o = []; i != rows && (o[i] = []); ++i)
    for (var j2 = 0; j2 != cols; ++j2) o[i][j2] = parse_SerAr(blob, opts.biff);
  return o;
}
...
function parse_PtgList(blob) {
  ...
  return { ixti, coltype: flags & 3, rt: rt2, idx, c, C };
}
...
function check_wb_names(N, S, codes) {
  N.forEach(function(n, i) {
    check_ws_name(n);
    for (var j2 = 0; j2 < i; ++j2) if (n == N[j2]) throw new Error("Duplicate Sheet Name: " + n);
    if (codes) {
...
function make_html_row(ws, r, R, o) {
  ...
  for (var C = r.s.c; C <= r.e.c; ++C) {
    var RS = 0, CS = 0;
    for (var j2 = 0; j2 < M3.length; ++j2) {
      if (M3[j2].s.r > R || M3[j2].s.c > C) continue;
      if (M3[j2].e.r < R || M3[j2].e.c < C) continue;
      if (M3[j2].s.r < R || M3[j2].s.c < C) {
        RS = -1;
        break;
      }
      RS = M3[j2].e.r - M3[j2].s.r + 1;
      CS = M3[j2].e.c - M3[j2].s.c + 1;
      break;
    }
    if (RS < 0) continue;
    var coord = encode_cell({ r: R, c: C });
...
var write_content_ods = /* @__PURE__ */ (function() {
  ...
  var write_ws2 = function(ws, wb, i) {
    ...
    for (R = 0; R < range.s.r; ++R) {
      H2 = ROWS[R] ? ' table:style-name="ro' + ROWS[R].ods + '"' : "";
      o.push("        <table:table-row" + H2 + "></table:table-row>\n");
    }
    for (; R <= range.e.r; ++R) {
      H2 = ROWS[R] ? ' table:style-name="ro' + ROWS[R].ods + '"' : "";
      o.push("        <table:table-row" + H2 + ">\n");
...
var Se = "@mindfiredigital/pivothead";
var ue = 1 * 1024 * 1024;
var j = 5 * 1024 * 1024;
var q = 8 * 1024 * 1024;
var B = 10 * 1024 * 1024;
...
function Te() {
  ...
  try {
    const c = require_pivothead_true(), { combine: e, label: t, colorize: r, printf: s, timestamp: a } = c.format, i = s(
      ({
        level: n,
        message: o,
        label: u,
...
<body>
  ...
  static generateExcel(e, t) {
    ...
    const g = [d, ...h], m = utils.aoa_to_sheet(g), C = utils.decode_range(m["!ref"] ?? "A1:A1"), S = [];
    for (let f = 0; f <= C.e.c; f++)
      S[f] = { wch: f === 0 ? 15 : 12 };
    m["!cols"] = S;
    for (let f = 1; f <= h.length; f++)
      for (let p = 1; p <= u.length * a.length; p++) {
        const w = utils.encode_cell({ r: f, c: p }), y = (p - 1) % a.length, D = a[y];
        if (D && D.format && m[w])
    ...
    utils.book_append_sheet(b, m, "Pivot Table"), writeFileSync(b, `${t}.xlsx`);
  }
  /**
  ...
  static openPrintDialog(e) {
    const t = _E.convertToHtml(e), r = window.open("", "_blank");
    if (!r) {
...
var et = class {
  constructor(e) {
    if (this.filterConfig = [], this.paginationConfig = {
      ...
      pageSize: 10,
      totalPages: 1
    }, this.autoAllColumnEnabled = false, this.cache = /* @__PURE__ */ new Map(), this.listeners = /* @__PURE__ */ new Set(), !this.validateConfig(e))
  ...
  validateConfig(e) {
    ...
    if (e.dataSource) {
      ...
      if (t === "remote" && !r || t === "file" && !s) return false;
    }
    return true;
  }
  initializeState(e) {
  ...
  ensureSyntheticAllColumn() {
    ...
    if (e && (this.state.columns = [
      ...
      const r = (s) => {
        ...
        let i = false;
        const n = a.map((o) => o && o.__all__ === void 0 ? (i = true, { ...o, __all__: "All" }) : o);
        return i ? n : a;
      };
  ...
  exportToHTML(e = "pivot-table") {
    ...
    ), E2.exportToHTML(this.getState(), e);
  }
  /**
   * Exports the pivot table data to PDF and downloads the file.
   * @param {string} fileName - The name of the downloaded file (without extension).
  ...
  exportToPDF(e = "pivot-table") {
    l.info("PivotEngine.exportToPDF called with fileName:", e), l.info(
      "PivotEngine state rawData length:",
      this.state.rawData?.length || 0
    ), E2.exportToPDF(this.getState(), e);
  }
  /**
   * Exports the pivot table data to Excel and downloads the file.
   * @param {string} fileName - The name of the downloaded file (without extension).
  ...
  exportToExcel(e = "pivot-table") {
    l.info("PivotEngine.exportToExcel called with fileName:", e), l.info(
      "PivotEngine state rawData length:",
      this.state.rawData?.length || 0
    ), E2.exportToExcel(this.getState(), e);
  }
  /**
   ...
   */
  openPrintDialog() {
    E2.openPrintDialog(this.getState());
  }
  ...
  reorderProductsByName(e, t, r = "before") {
    try {
      const s = [
        ...new Set(this.state.data.map((o) => o.product))
      ], a = s.indexOf(e), i = s.indexOf(t);
      if (a === -1 || i === -1) {
        l.warn("Invalid product names for reordering:", {
          fromProduct: e,
          toProduct: t
        });
        return;
      }
      const n = r === "after" ? i + 1 : i;
      this.dragDataRow(a, n);
    } catch (s) {
      l.error("Error reordering products by name:", s);
    }
  }
  //swap logic
   ...
   */
  swapDataRows(e, t) {
    const r = this.state.rows && this.state.rows.length > 0 ? this.state.rows[0] : null;
    if (!r) {
      l.warn("No row field configured for swapping");
      return;
    }
    const s = r.uniqueName, a = this.state.customRowOrder;
    let i;
    if (a && a.fieldName === s && a.order ? i = [...a.order] : i = [
      ...new Set((this.config.data || []).map((n) => n[s]))
    ].filter(
      (n) => typeof n == "string" && n !== null && n !== void 0
    ), l.info(
      `Row swap validation: ${s} has ${i.length} unique values:`,
      i
    ), e < 0 || t < 0 || e >= i.length || t >= i.length) {
      l.warn("Invalid indices for row swap operation:", {
        fromIndex: e,
        toIndex: t,
        totalRows: i.length,
        fieldName: s
    ...
    if (e !== t)
      try {
        const n = i[e], o = i[t], u = [...this.config.data || []], d = [...i];
        d[e] = o, d[t] = n, this.state.customRowOrder = {
          fieldName: s,
          order: d
        }, u.sort((h, g) => {
          const m = d.indexOf(h[s]), C = d.indexOf(g[s]);
          return m - C;
        }), this.config.data = u, this.state.rawData = u, this.state.data = u, this.state.processedData = this.generateProcessedDataForDisplay(), this.state.groups.length > 0 && this.updateAggregates(), typeof this.config.onRowDragEnd == "function" && this.config.onRowDragEnd(e, t, this.state.rowGroups), l.info(`Row swap completed successfully for field: ${s}`), this._emit();
      } catch (n) {
        l.error("Error during row swap operation:", n);
      }
  }
  /**
   ...
   */
  swapDataColumns(e, t) {
    const r = this.state.columns && this.state.columns.length > 0 ? this.state.columns[0] : null;
    if (!r) {
      l.warn("No column field configured for swapping");
      return;
    }
    const s = r.uniqueName, a = this.state.customColumnOrder;
    let i;
    if (a && a.fieldName === s && a.order ? i = [...a.order] : i = [
      ...new Set((this.config.data || []).map((n) => n[s]))
    ].filter(
      ...
      `Column swap validation: ${s} has ${i.length} unique values:`,
      i
    ), e < 0 || t < 0 || e >= i.length || t >= i.length) {
      l.warn("Invalid indices for column swap operation:", {
        fromIndex: e,
        toIndex: t,
    ...
    if (e !== t)
      try {
        const n = i[e], o = i[t], u = [...i];
        if (u[e] = o, u[t] = n, this.state.columns && this.state.columns.length > 0) {
          const d = [...this.state.columns], h = d.findIndex(
            (m) => m.uniqueName === n
          ), g = d.findIndex(
            (m) => m.uniqueName === o
          );
          h !== -1 && g !== -1 && ([d[h], d[g]] = [
            d[g],
            d[h]
          ], this.state.columns = d, l.info("Updated column configurations"));
        }
        if (this.state.customColumnOrder = {
          ...
          this.config.onColumnDragEnd(e, t, d);
        }
        l.info(
          `Column swap completed successfully for field: ${s}`
        ), this._emit();
      } catch (n) {
        l.error("Error during column swap operation:", n);
      }
  }
  /**
  ...
  getUniqueFieldValues(e) {
    ...
    l.info(
      `Getting unique values for field: ${e} from ${t.length} total items`
    );
    const r = [
      ...new Set(t.map((s) => s[e]))
    ].filter(
      (s) => typeof s == "string" && s !== null && s !== void 0
    );
    return l.info(
      `Found ${r.length} unique values for ${e}:`,
      r
    ), r;
  }
  ...
  getOrderedUniqueFieldValues(e, t = false) {
    const r = t ? this.state.customRowOrder : this.state.customColumnOrder;
    return r && r.fieldName === e && r.order ? (l.info(`Using custom order for ${e}:`, r.order), r.order) : this.getUniqueFieldValues(e);
  }
  /**
   ...
   */
  setCustomFieldOrder(e, t, r = true) {
    const s = { fieldName: e, order: t };
    r ? this.state.customRowOrder = s : this.state.customColumnOrder = s, this.state.processedData = this.generateProcessedDataForDisplay(), this._emit();
  }
  /**
  ...
  getOrderedColumnValues() {
    ...
    return e && e.order && e.order.length > 0 ? (l.info(
      "Engine returning custom column order:",
      e.order
    ), e.order) : (l.info("Engine has no custom column order"), null);
  }
  /**
  ...
  getOrderedRowValues() {
    ...
    return e && e.order && e.order.length > 0 ? (l.info("Engine returning custom row order:", e.order), e.order) : (l.info("Engine has no custom row order"), null);
  }
  /**
  ...
  swapRawDataRows(e, t) {
    if (!this.state.data || this.state.data.length === 0) {
      l.warn("No data available for raw row swap");
      return;
    }
    if (e < 0 || t < 0 || e >= this.state.data.length || t >= this.state.data.length) {
      l.warn("Invalid indices for raw row swap operation:", {
        fromIndex: e,
        toIndex: t,
    ...
    if (e !== t)
      try {
        const r = [...this.state.data], s = r[e];
        r[e] = r[t], r[t] = s, this.state.data = r, this.state.rawData = r, this.state.dataHandlingMode === "raw" ? this.state.processedData = this.generateProcessedDataForDisplay() : this.state.processedData = this.generateProcessedDataForDisplay(), this._emit();
      } catch (r) {
        l.error("Error during raw row swap operation:", r);
      }
  }
  /**
  ...
  hasAggregatedFilters() {
    return this.filterConfig.some((e) => e.field.includes("_") && this.state.measures.some(
      (t) => e.field === `${t.aggregation}_${t.uniqueName}`
    ));
  }
  /**
  ...
  filterProcessedData(e) {
    ...
    const t = this.filterConfig.filter(
      (a) => a.field.includes("_") && this.state.measures.some(
        (i) => a.field === `${i.aggregation}_${i.uniqueName}`
      )
    ), r = this.filterConfig.filter(
      (a) => !a.field.includes("_") || !this.state.measures.some(
        (i) => a.field === `${i.aggregation}_${i.uniqueName}`
      )
    );
    let s = e;
    return r.length > 0 && (s = s.filter(
      (a) => r.every((i) => {
        const n = a[i.field], o = typeof n == "number" ? Number(i.value) : i.value;
        switch (i.operator) {
          case "equals":
            return typeof n == "string" && typeof o == "string" ? n.toLowerCase() === o.toLowerCase() : n === o;
          case "contains":
            return String(n).toLowerCase().includes(String(o).toLowerCase());
          case "greaterThan":
    ...
    )), t.length > 0 && (this.state.groupConfig && this.applyGrouping(s), s = this.state.groups.filter(
      (i) => t.every((n) => {
        const o = i.aggregates[n.field], u = typeof n.value == "string" ? Number(n.value) : n.value;
        switch (n.operator) {
          case "equals":
            return o === u;
          case "greaterThan":
          ...
          case "lessThan":
            return o < u;
          case "between": {
            const d = Array.isArray(u) ? u : [u, u];
            return o >= Number(d[0]) && o <= Number(d[1]);
          }
          default:
            return true;
        }
   ...
   */
  setLayout(e, t, r) {
    this.state.rows = e || [], this.state.columns = t || [], this.state.measures = this.normalizeMeasures(r || []), this.state.selectedMeasures = [...this.state.measures], this.state.selectedDimensions = [
      ...e.map(
        (s) => ({
          field: s.uniqueName,
          label: s.caption || s.uniqueName,
          type: "string"
        })
      ),
      ...t.map(
    ...
    ], this.ensureSyntheticAllColumn(), this.state.processedData = this.generateProcessedDataForDisplay(), this.updateAggregates(), this._emit();
  }
  /**
   ...
   * @public
   */
  setRowsAndColumns(e, t) {
    this.state.rows = e || [], this.state.columns = t || [], this.ensureSyntheticAllColumn(), this.state.processedData = this.generateProcessedDataForDisplay(), this.updateAggregates(), this._emit();
  }
  normalizeMeasures(e = []) {
    return (e || []).map((t) => !(!!t.caption && t.caption.trim().toLowerCase() !== t.uniqueName.toLowerCase()) && (t.aggregation || this.config.defaultAggregation) === "sum" ? { ...t, caption: `sum of ${t.uniqueName}` } : t);
  }
};
var tt = class {
  /** Returns all fields inferred from the engine's raw data */
  static getAvailableFields(e) {
    const r = e.getState().rawData || [];
    if (!Array.isArray(r) || r.length === 0) return [];
    const s = r.slice(0, Math.min(200, r.length)), a = /* @__PURE__ */ new Set();
    s.forEach(
      (n) => Object.keys(n || {}).forEach((o) => a.add(o))
    );
    const i = [];
    return a.forEach((n) => {
      i.push({ name: n, type: this.inferFieldType(s, n) });
    }), i.sort((n, o) => n.name.localeCompare(o.name));
  }
  /** Supported aggregations */
  static getSupportedAggregations() {
    return ["sum", "avg", "min", "max", "count"];
  }
  /** Change aggregation for a specific measure and refresh engine */
  static setMeasureAggregation(e, t, r) {
    const a = [...e.getState().measures], i = a.findIndex((n) => n.uniqueName === t);
    i === -1 ? a.push(this.buildMeasure(t, r)) : a[i] = { ...a[i], aggregation: r }, e.setMeasures(a);
  }
  /** Build complete layout (rows, columns, measures) from selection */
  static buildLayout(e) {
    const t = (e.rows || []).map((a) => ({
      uniqueName: a,
      caption: this.toCaption(a)
    })), r = (e.columns || []).map((a) => ({
      uniqueName: a,
      caption: this.toCaption(a)
    })), s = (e.values || []).map(
      (a) => this.buildMeasure(a.field, a.aggregation)
    );
    return { rows: t, columns: r, measures: s };
  }
  /** Build a single MeasureConfig */
  static buildMeasure(e, t) {
    const r = t || "sum";
    return {
      uniqueName: e,
      caption: `${this.capitalize(r)} of ${this.toCaption(e)}`,
      aggregation: r
    };
  }
  // --- helpers ---
  static inferFieldType(e, t) {
    let r = 0, s = 0;
    return e.forEach((a) => {
      const i = a?.[t];
      if (i == null) return;
      typeof i == "number" || !isNaN(Number(i)) && i !== "" ? r++ : this.looksLikeDate(i) && s++;
    }), r > 0 && r >= s ? "number" : s > 0 ? "date" : "string";
  }
  static looksLikeDate(e) {
    if (typeof e != "string" && !(e instanceof Date)) return false;
    const t = Date.parse(String(e));
    return !isNaN(t);
  }
  static toCaption(e) {
    return e.replace(/([a-z0-9])([A-Z])/g, "$1 $2").replace(/[_-]+/g, " ").replace(/^\w/, (t) => t.toUpperCase());
  }
  static capitalize(e) {
...
var We = class {
  constructor(e, t) {
    this.workers = [], this.taskQueue = [], this.nextTaskId = 0, this.workerUrl = e, this.workerCount = t || Math.max(1, navigator.hardwareConcurrency - 1), this.initializeWorkers();
  }
  /**
   * Initialize worker pool
   */
  initializeWorkers() {
    for (let e = 0; e < this.workerCount; e++) {
      const t = new Worker(this.workerUrl, { type: "module" });
      this.workers.push({
        worker: t,
        busy: false
      });
  ...
  execute(e) {
    return new Promise((t, r) => {
      ...
      this.taskQueue.push(a), this.processQueue();
    });
  }
  /**
   ...
   */
  processQueue() {
    const e = this.workers.find((a) => !a.busy);
    if (!e || this.taskQueue.length === 0)
      return;
    const t = this.taskQueue.shift();
    if (!t) return;
    e.busy = true, e.currentTaskId = t.id;
    const r = (a) => {
      const i = a.data;
      i.type === "CHUNK_PARSED" ? (e.worker.removeEventListener("message", r), e.worker.removeEventListener("error", s), e.busy = false, e.currentTaskId = void 0, i.error ? t.reject(new Error(i.error)) : t.resolve(i), this.processQueue()) : i.type;
    }, s = (a) => {
      e.worker.removeEventListener("message", r), e.worker.removeEventListener("error", s), e.busy = false, e.currentTaskId = void 0, t.reject(a), this.processQueue();
    };
    e.worker.addEventListener("message", r), e.worker.addEventListener("error", s), e.worker.postMessage(t.data);
  }
  /**
   * Terminate all workers
   */
  terminate() {
    this.workers.forEach(({ worker: e }) => e.terminate()), this.workers = [], this.taskQueue = [];
  }
  /**
   ...
   */
  getBusyCount() {
    return this.workers.filter((e) => e.busy).length;
  }
  /**
...
var X = class X2 {
   ...
   */
  static async readFileInChunks(e, t = {}) {
    const r = t.chunkSizeBytes || this.DEFAULT_CHUNK_SIZE, s = e.size;
    let a = 0, i = 0;
    if (!e.stream)
      return this.readFileInChunksLegacy(e, t);
    try {
      const o = e.stream().getReader(), u = new TextDecoder(t.encoding || "utf-8");
      let d = "", h = false, g = false;
      for (; !h && !g; ) {
        if (t.signal?.aborted) {
          g = true, o.cancel();
          break;
        ...
        if (h = C, m)
          for (a += m.length, d += u.decode(m, { stream: !h }); d.length >= r || h && d.length > 0; ) {
            if (t.signal?.aborted) {
              g = true, h || o.cancel();
              break;
            }
            const S = d.slice(0, r);
            d = d.slice(r);
            const b = Math.min(100, a / s * 100), f = {
              chunkId: i++,
              text: S,
              isFirstChunk: i === 1,
              isLastChunk: h && d.length === 0,
              progress: b
            };
            if (t.onChunk && await t.onChunk(f), t.onProgress && t.onProgress(b), h && d.length === 0)
              break;
          }
      }
      if (d.length > 0) {
        ...
        t.onChunk && await t.onChunk(m), t.onProgress && t.onProgress(100);
      }
    } catch (n) {
      throw l.error("Error reading file stream:", n), n;
    }
  }
  /**
   * Legacy fallback for browsers without stream() support
   */
  static async readFileInChunksLegacy(e, t = {}) {
    const r = t.chunkSizeBytes || this.DEFAULT_CHUNK_SIZE, s = e.size;
    let a = 0, i = 0;
    for (; a < s && !t.signal?.aborted; ) {
      const n = Math.min(a + r, s), o = e.slice(a, n), u = await this.readBlobAsText(o, t.encoding), d = Math.min(100, n / s * 100), h = {
        chunkId: i++,
        text: u,
        isFirstChunk: a === 0,
        isLastChunk: n >= s,
      ...
      t.onChunk && await t.onChunk(h), t.onProgress && t.onProgress(d), a = n;
    }
  }
  /**
   * Read blob as text using FileReader
   */
  static readBlobAsText(e, t) {
    return new Promise((r, s) => {
      const a = new FileReader();
      a.onload = () => {
        r(a.result);
      }, a.onerror = () => {
        s(new Error("Failed to read blob"));
      }, a.readAsText(e, t || "utf-8");
    });
  }
  /**
   * Get optimal chunk size based on file size
   */
  static getOptimalChunkSize(e) {
    return e < 1024 * 1024 ? 256 * 1024 : e < 10 * 1024 * 1024 ? 1024 * 1024 : e < 100 * 1024 * 1024 ? 2 * 1024 * 1024 : 5 * 1024 * 1024;
  }
};
X.DEFAULT_CHUNK_SIZE = 1024 * 1024;
var $2 = X;
function he() {
...
function ze() {
  try {
    if (typeof __dirname < "u")
      return new Function("module", "return require(module)")("path").join(__dirname, "wasm", "csvParser.wasm");
  } catch (c) {
    l.warn("Could not resolve __dirname:", c);
  }
...
function fe() {
  ...
  try {
    if (typeof import.meta < "u" && import.meta.url) {
      const c = import.meta.url, t = `${c.substring(0, c.lastIndexOf("/"))}/csvParser.wasm`;
      return l.info(`Computed WASM URL: ${t}`), t;
    }
  } catch (c) {
    l.warn("import.meta.url not available:", c);
  }
  return l.warn("Using fallback WASM path"), "/wasm/csvParser.wasm";
}
function Q(c) {
  return c.length >= 4 && c[0] === 0 && c[1] === 97 && c[2] === 115 && c[3] === 109;
}
function qe(c) {
  const e = new Function("module", "return require(module)"), t = e("fs"), r = e("path"), s = [
    c,
    r.resolve(c),
    r.join(__dirname, "wasm", "csvParser.wasm"),
    // For UMD build: dist/wasm/csvParser.wasm
    r.join(__dirname, "csvParser.wasm"),
    // For ESM build in wasm dir
    r.join(__dirname, "../wasm/csvParser.wasm"),
    // One level up
    r.join(
      process.cwd(),
  ...
  for (const a of s)
    try {
      if (t.existsSync(a)) {
        l.info(`✅ Loading WASM from: ${a}`);
        const i = t.readFileSync(a), n = i.buffer.slice(
          i.byteOffset,
          i.byteOffset + i.byteLength
        ), o = new Uint8Array(n);
        if (Q(o))
          return n;
        l.warn(`Invalid WASM file at ${a}`);
      }
    } catch {
    }
  throw new Error(
...
async function Oe() {
  ...
  if (he())
    try {
      ...
      throw l.error("Failed to load WASM in Node.js:", e), e;
    }
  try {
    ...
    if (Q(r))
      return t;
    {
      const s = String.fromCharCode(...r.slice(0, 4));
      throw s === "<!DO" || s === "<htm" ? new Error(
        `Received HTML instead of WASM binary from ${c} - likely a 404 error`
      ) : new Error(`Invalid WASM file format from ${c}`);
    }
  } catch (e) {
    l.warn(`Failed to fetch WASM from ${c}:`, e);
    const t = [
      "/wasm/csvParser.wasm",
      "/node_modules/@mindfiredigital/pivothead/dist/wasm/csvParser.wasm"
    ];
    for (const r of t)
      if (r !== c)
        try {
          l.info(`Trying fallback URL: ${r}`);
          const s = await fetch(r);
          if (!s.ok) continue;
          const a = await s.arrayBuffer(), i = new Uint8Array(a);
          if (Q(i))
            return l.info(
              `✅ Successfully loaded WASM from fallback: ${r}`
            ), a;
        } catch (s) {
          l.warn(`Fallback ${r} failed:`, s);
        }
    throw new Error(
      `Failed to fetch WASM from ${c} and all fallback URLs. Make sure to run 'pnpm build:wasm' in the core package.`
    );
  }
}
var O = null;
async function Ve() {
  if (O) return O;
  try {
    return O = (await import("./index-DFEh6Cpe-ITPFBAZJ.js")).instantiate, O;
  } catch (c) {
    return l.warn("AssemblyScript loader not available:", c), null;
  }
}
var M = class M2 {
  constructor() {
    this.wasmModule = null, this.isLoaded = false, this.loadPromise = null;
  }
  /**
   * Get singleton instance
   */
  static getInstance() {
    return M2.instance || (M2.instance = new M2()), M2.instance;
  }
  /**
  ...
  static isSupported() {
    try {
      return typeof WebAssembly < "u" && typeof WebAssembly.instantiate == "function";
    } catch {
      return false;
    }
  }
  ...
  async load() {
    if (!this.isLoaded)
      return this.loadPromise ? this.loadPromise : (this.loadPromise = this._loadModule(), this.loadPromise);
  }
  /**
  ...
  async _loadModule() {
    try {
      ...
      l.info("🚀 Loading WebAssembly CSV parser...");
      const t = fe();
      l.info(`Loading WASM from: ${t}`);
      let r;
      try {
        r = await Oe(), l.info(
          `✅ WASM file loaded successfully (${r.byteLength} bytes)`
        );
      } catch (a) {
        throw l.error(
          `❌ Failed to fetch WASM file from ${t}:`,
          a
        ), new Error(
          `WASM file not found at ${t}. Make sure to run 'npm run build:wasm' in the core package.`
        );
      }
      this.wasmModule = await e(r, {
        env: {
          abort: (a, i, n, o) => {
            l.error(`WASM abort: ${a} at ${i}:${n}:${o}`);
          }
        }
      }), this.isLoaded = true;
      const s = this.wasmModule.exports.getVersion();
      l.info(
        `✅ WebAssembly CSV parser loaded successfully (v${s})`
      );
    } catch (e) {
      throw this.isLoaded = false, this.loadPromise = null, l.error("❌ Failed to load WASM module:", e), e;
    }
  }
  /**
  ...
  parseCSVChunk(e, t = {}) {
    ...
    const r = t.delimiter?.charCodeAt(0) ?? 44, s = t.hasHeader ?? true, a = t.trimValues ?? true;
    try {
      const i = this.wasmModule.exports.parseCSVChunk(
        this.wasmModule.exports.__newString(e),
        r,
        s ? 1 : 0,
        a ? 1 : 0
      ), n = this.wasmModule.exports.getLastRowCount(), o = this.wasmModule.exports.getLastColCount(), u = this.wasmModule.exports.getLastErrorMessage(), d = this.wasmModule.exports.__getString(u);
      return {
        rowCount: n,
        colCount: o,
        errorCode: i,
      ...
      throw l.error("Error in WASM parseCSVChunk:", i), i;
    }
  }
  /**
   * Extract field from CSV data using WASM
   */
  extractField(e, t, r, s = true) {
    if (!this.isLoaded || !this.wasmModule)
      throw new Error("WASM module not loaded. Call load() first.");
    const a = this.wasmModule.exports.extractField(
      this.wasmModule.exports.__newString(e),
      t,
      r,
      s ? 1 : 0
    );
    return this.wasmModule.exports.__getString(a);
  }
  /**
  ...
  estimateMemory(e, t) {
    if (!this.isLoaded || !this.wasmModule)
      throw new Error("WASM module not loaded. Call load() first.");
    return this.wasmModule.exports.estimateMemory(e, t);
  }
  /**
  ...
  getVersion() {
    if (!this.isLoaded || !this.wasmModule)
      throw new Error("WASM module not loaded. Call load() first.");
    const e = this.wasmModule.exports.getVersion();
    return this.wasmModule.exports.__getString(e);
  }
  /**
   * Run benchmark
   */
   ...
   */
  unload() {
    this.wasmModule && this.wasmModule.exports.__release && this.wasmModule.exports.__release(), this.wasmModule = null, this.isLoaded = false, this.loadPromise = null;
  }
};
M.instance = null;
var T = M;
var He = () => T.getInstance();
var Ue = class {
  constructor() {
    this.isInitialized = false, this.wasmLoader = He();
  }
  /**
  ...
  async initialize() {
    if (this.isInitialized)
      return true;
    try {
      return T.isSupported() ? (await this.wasmLoader.load(), this.isInitialized = true, true) : (l.warn(
        "⚠️ WebAssembly not supported, falling back to Web Workers"
      ), false);
    } catch (e) {
      return l.warn("⚠️ Failed to initialize WASM:", e), false;
    }
  }
  /**
  ...
  async processCSV(e, t = {}) {
    ...
    try {
      ...
      const {
        ...
        hasHeader: a = true,
        trimValues: i = true,
        skipEmptyLines: n = true
      } = t;
      l.info("🚀 Processing CSV with WebAssembly...");
      const o = this.wasmLoader.parseCSVChunk(e, {
        delimiter: s,
        hasHeader: a,
        trimValues: i
      });
      if (o.errorCode !== 0)
        throw new Error(o.errorMessage || "WASM parsing failed");
      l.info(
        `📊 WASM parsed: ${o.rowCount} rows, ${o.colCount} columns`
      );
      const u = this.parseCSVRows(e, {
        delimiter: s,
        hasHeader: a,
        trimValues: i,
        skipEmptyLines: n
      ...
      let d, h;
      t.providedHeaders && t.providedHeaders.length > 0 ? (d = t.providedHeaders, h = u) : a && u.length > 0 ? (d = u[0], h = u.slice(1)) : (d = void 0, h = u);
      const g = this.rowsToObjects(h, d), m = performance.now() - r;
      return l.info(`✅ WASM processing completed in ${m.toFixed(2)}ms`), {
        success: true,
        data: g,
        headers: d,
        rowCount: h.length,
      ...
      return l.error("❌ WASM processing error:", s), {
        success: false,
        data: [],
        rowCount: 0,
        colCount: 0,
  ...
  parseCSVRows(e, t) {
    const {
      delimiter: r = ",",
      trimValues: s = true,
      skipEmptyLines: a = true
    } = t, i = [];
    let n = [], o = "", u = false;
    for (let d = 0; d < e.length; d++) {
      const h = e[d], g = d + 1 < e.length ? e[d + 1] : "";
      u ? h === '"' ? g === '"' ? (o += '"', d++) : u = false : o += h : h === '"' ? u = true : h === r ? (n.push(s ? o.trim() : o), o = "") : h === `
` || h === "\r" ? (h === "\r" && g === `
` && d++, n.push(s ? o.trim() : o), o = "", (!a || n.some((m) => m !== "")) && i.push(n), n = []) : o += h;
    }
    return (o !== "" || n.length > 0) && (n.push(s ? o.trim() : o), (!a || n.some((d) => d !== "")) && i.push(n)), i;
  }
  /**
   * Convert rows to objects
   */
  rowsToObjects(e, t) {
    return !t || t.length === 0 ? e.map((r) => ({ ...r })) : e.map((r) => {
      const s = {};
      return t.forEach((a, i) => {
        const n = r[i] ?? "";
        if (this.isReady() && n !== "")
          switch (this.wasmLoader.detectFieldType(n)) {
            case 1:
              s[a] = this.wasmLoader.parseNumber(n);
              break;
            case 2:
              s[a] = n.toLowerCase() === "true";
              break;
            case 3:
              s[a] = null;
              break;
  ...
  async processFile(e, t = {}) {
    try {
      if (e.size > q)
        return l.warn(
          `⚠️ File too large for WASM (${(e.size / 1024 / 1024).toFixed(2)}MB > 8MB). Should use Web Workers instead.`
        ), {
          success: false,
          data: [],
          rowCount: 0,
          colCount: 0,
          parseTime: 0,
          error: `File too large for WASM processing (${(e.size / 1024 / 1024).toFixed(2)}MB). Falling back to Web Workers.`
        };
      const r = await e.text();
      return this.processCSV(r, t);
    } catch (r) {
      return {
        success: false,
        data: [],
   ...
   */
  estimateMemory(e, t) {
    return this.isReady() ? this.wasmLoader.estimateMemory(e, t) : e * t * 64;
  }
  /**
   * Get WASM version
   */
  getVersion() {
    return this.isReady() ? this.wasmLoader.getVersion() : "N/A";
  }
  /**
   * Cleanup and release resources
   */
  cleanup() {
    this.wasmLoader && this.wasmLoader.unload(), this.isInitialized = false;
  }
};
var U = null;
var ie = () => (U || (U = new Ue()), U);
function me(c) {
  ...
  let e = c.trim();
  if (!e) return null;
  const t = /[€£¥₹$]/.test(e), r = /[A-Za-z]/.test(e), s = /[.,]/.test(e), a = e.startsWith("(") && e.endsWith(")");
  if (r && !t || !t && !s && !a) return null;
  let i = false;
  if (a && (i = true, e = e.slice(1, -1)), e = e.replace(/[^0-9,.-]/g, ""), (e.match(/-/g) || []).length > 1) return null;
  e = e.replace(/(.*)-(.*)/, "-$1$2");
  const n = e.includes("."), o = e.includes(","), u = e.lastIndexOf("."), d = e.lastIndexOf(",");
  let h = e;
  if (n && o) {
    const m = u > d ? "." : ",", C = m === "." ? "," : ".";
    h = h.split(C).join(""), h = h.replace(m, ".");
  } else if (o && !n) {
    const m = e.split(",");
    if (m.length > 2)
      h = m.join("");
      ...
      const C = m[1];
      C.length === 2 || C.length === 3 ? h = m[0] + "." + C : h = m.join("");
    }
  } else if (n && !o) {
    const m = e.split(".");
    if (m.length > 2) {
    ...
    h = e;
  const g = Number(h);
  return isNaN(g) ? null : i ? -g : g;
}
function J(c, e) {
  const t = {}, r = c.slice(0, Math.min(200, c.length));
  for (const s of e) {
    let a = 0, i = 0, n = 0, o = 0, u = 0;
    for (const g of r) {
      const m = g?.[s];
      if (m == null || m === "") {
        u++;
      ...
      if (typeof m == "number") a++;
      else if (typeof m == "boolean") o++;
      else if (typeof m == "string") {
        if (me(m) !== null) {
          a++;
          continue;
        }
        const S = Date.parse(m);
        !isNaN(S) && /\d{4}-\d{2}-\d{2}|\//.test(m) ? n++ : isNaN(Number(m)) ? i++ : a++;
      } else m instanceof Date ? n++ : i++;
    }
    switch ((Object.entries({ num: a, str: i, date: n, bool: o, nul: u }).sort((g, m) => m[1] - g[1])[0] || [
      "str"
    ])[0]) {
      case "num":
        t[s] = "number";
...
function Ie(c, e) {
  const t = c.split(`
`).filter((n) => e.skipEmptyLines ? n.trim() !== "" : true);
  if (t.length === 0) return [];
  const r = e.delimiter || ",";
  let s = [], a = 0;
  e.hasHeader ? (s = I(t[0], r), e.trimValues && (s = s.map((n) => n.trim())), a = 1) : s = I(t[0], r).map((o, u) => `Column_${u + 1}`);
  const i = [];
  for (let n = a; n < t.length; n++) {
    ...
    s.forEach((d, h) => {
      let g = o[h] || "";
      e.trimValues && (g = g.trim()), u[d] = Ge(g);
    }), i.push(u);
  }
  return i;
}
function I(c, e) {
  ...
  for (let a = 0; a < c.length; a++) {
    const i = c[a];
    i === '"' && (a === 0 || c[a - 1] === e || s) ? s = !s : i === e && !s ? (t.push(r), r = "") : r += i;
  }
  return t.push(r), t;
}
function Ge(c) {
  ...
  return !isNaN(r) && (e.match(/^\d{4}-\d{2}-\d{2}/) || e.includes("/")) ? new Date(r).toISOString().split("T")[0] : e;
}
function je(c) {
  if (!c || c.length === 0) return c;
  const e = JSON.parse(JSON.stringify(c)), t = Object.keys(e[0]), r = J(e, t);
  for (const s of e)
    for (const a of t)
      if (r[a] === "number" && typeof s[a] == "string") {
        const i = parseFloat(s[a]);
        isNaN(i) || (s[a] = i);
      }
  return e;
}
var V = [".csv", ".txt"];
var H = [".json", ".jsonl"];
var Be = 1024 * 1024 * 1024;
function G(c) {
  return new Promise((e) => {
    const t = document.createElement("input");
    t.type = "file", t.accept = c.join(","), t.style.display = "none", t.onchange = (r) => {
      const a = r.target.files?.[0] || null;
...
function ne(c, e) {
  const t = e.maxFileSize || Be;
  if (c.size > t)
    return {
      success: false,
      error: `File size (${A(c.size)}) exceeds maximum allowed size (${A(t)})`
    };
  const r = ge(c.name), s = [
    ...V,
    ...H
  ];
  return s.includes(r) ? { success: true } : {
    success: false,
    error: `Unsupported file type: ${r}. Supported types: ${s.join(", ")}`
  };
}
function oe(c, e) {
  return new Promise((t, r) => {
    ...
    s.onload = () => {
      e && e(100), t(s.result);
    }, s.onerror = () => r(new Error("Failed to read file")), e && (s.onprogress = (a) => {
      if (a.lengthComputable) {
        const i = a.loaded / a.total * 100;
        e(i);
      }
    }), s.readAsText(c);
  });
...
function ge(c) {
  return c.toLowerCase().substring(c.lastIndexOf("."));
}
function A(c) {
  if (c === 0) return "0 Bytes";
  const e = 1024, t = ["Bytes", "KB", "MB", "GB"], r = Math.floor(Math.log(c) / Math.log(e));
  return parseFloat((c / Math.pow(e, r)).toFixed(2)) + " " + t[r];
}
function Ke(c, e) {
  const t = [];
  if (e.length === 0)
    return t.push("No columns detected in data"), t;
  const r = e.filter((n) => !n || n.trim() === "");
  r.length > 0 && t.push(`Found ${r.length} columns with empty names`);
  const s = e.filter(
    (n, o) => e.indexOf(n) !== o
  );
  s.length > 0 && t.push(
    `Found duplicate column names: ${[...new Set(s)].join(", ")}`
  );
  const a = Math.min(100, c.length), i = [];
  for (let n = 0; n < a; n++) {
    const o = c[n];
    Object.keys(o).length !== e.length && i.push(n + 1);
  }
  return i.length > 0 && t.push(
    `Found ${i.length} rows with inconsistent column count in sample`
  ), t;
}
function Qe(c, e) {
  const t = e.split(".");
  let r = c;
  for (const s of t)
    if (r && typeof r == "object" && r !== null && s in r)
      r = r[s];
    else
      return [];
...
var ee = class ee2 {
   ...
   */
  static shouldUseWorkers(e, t) {
    return t !== void 0 ? e >= this.config.useWorkersAboveSize || t >= this.config.useWorkersAboveRows : e >= this.config.useWorkersAboveSize;
  }
  /**
   * Check if WASM should be used for given size/rows
   */
  static shouldUseWasm(e, t) {
    return t !== void 0 ? e >= this.config.useWasmAboveSize || t >= this.config.useWasmAboveRows : e >= this.config.useWasmAboveSize;
  }
  /**
   * Check if drag/drop should be enabled
   */
  static isDragDropAllowed(e) {
    return e <= this.config.maxRowsForDragDrop;
  }
  /**
   * Check if pagination is required
   */
  static requiresPagination(e) {
    return e > this.config.maxRowsForFullRender;
  }
  /**
   * Get appropriate page size for dataset
   */
  static getPageSize(e) {
    return e <= 100 || e <= 1e3 ? 50 : (e <= 1e4, 100);
  }
  /**
   * Check if sampling should be used
   */
  static shouldSample(e) {
    return e > this.config.sampleThreshold;
  }
  /**
   * Get sample size for dataset
   */
  static getSampleSize(e) {
    return this.shouldSample(e) ? Math.min(this.config.sampleSize, e) : e;
  }
  /**
   * Get optimal chunk size for file
   */
  static getChunkSize(e) {
    return e < ae ? Ce : e < ke ? ae : e < Fe ? De : ve;
  }
  /**
   * Get performance mode for dataset
   * Returns the optimal processing mode based on file size
   */
  static getPerformanceMode(e, t) {
    return e > q ? "streaming-wasm" : e >= j && e <= q ? "wasm" : this.shouldUseWorkers(e, t) ? "workers" : "standard";
  }
  /**
   ...
   */
  static shouldUseVirtualScroll(e) {
    return this.config.enableVirtualScroll && e >= this.config.virtualScrollThreshold;
  }
  /**
...
ee.config = {
  ...
  useWorkersAboveSize: ue,
  useWorkersAboveRows: 5e3,
  // 5k rows
  // WASM configuration - for files >= 5MB (up to 8MB safety limit)
  // Strategy: Workers for < 5MB, WASM for 5-8MB, Workers for > 8MB (streaming)
  useWasmAboveSize: j,
  useWasmAboveRows: 2e4,
  // 20k rows
  // UI interaction limits (with virtual scrolling support)
  maxRowsForDragDrop: 1e3,
  // Traditional rendering limit (virtual scrolling handles larger datasets)
  maxRowsForFullRender: 1e4,
  ...
  virtualScrollThreshold: 1e3,
  // Auto-enable at 1k rows
...
var z = ee;
function Je(c) {
  const e = c.length > 0 ? Object.keys(c[0]) : [];
  let t = c;
  if (e.length === 1) {
    const [f] = e, p = [];
    if (J(t, e)[f] === "number") {
      for (let F = 0; F < t.length; F++)
        t[F].__all__ = "All";
      const k = [{ uniqueName: "__all__", caption: "All" }], v = [
        { uniqueName: "__all__", caption: "All" }
      ];
      return p.push({
        uniqueName: f,
        ...
        measures: p,
        data: t,
        columnsList: ["__all__", ...e]
      };
    }
    for (let k = 0; k < t.length; k++)
      t[k].__all__ = "All";
    return {
      rows: [{ uniqueName: f, caption: f }],
      columns: [
        { uniqueName: "__all__", caption: "All" }
      ],
      measures: p,
  ...
  const r = J(t, e), s = e.filter((f) => r[f] === "number"), a = e.filter((f) => r[f] !== "number"), i = s.map((f) => {
    const p = t.some((w) => {
      const y = w[f];
  ...
  let n = [], o = [];
  const u = t.length || 1, d = u > 1e4, h = d ? Math.min(5e3, u) : u, g = d ? t.slice(0, h) : t, m = (f) => {
    const p = new Set(g.map((y) => y?.[f])).size;
    if (!d) return p;
    const w = Math.round(p * (u / h));
    return Math.min(w, u);
  }, C = (f) => new Set(g.map((p) => p?.[f])).size;
  if (a.length === 0) {
    for (let f = 0; f < t.length; f++)
      t[f].__all__ = "All";
    return n = [{ uniqueName: "__all__", caption: "All" }], o = [{ uniqueName: "__all__", caption: "All" }], {
      rows: n,
      columns: o,
      measures: i,
      data: t,
  ...
  const S = a.map((f) => ({ f, u: m(f) })).sort((f, p) => f.u - p.u);
  l.info("DEBUG: Non-numeric fields:", a), l.info("DEBUG: Ranked fields:", S), l.info("DEBUG: Total rows:", u);
  const b = S.filter((f) => {
    const p = C(f.f);
    return f.u > 1 && f.u < u && p <= Ne;
  });
  if (l.info(
    ...
    S.map((f) => ({ field: f.f, unique: f.u }))
  ), b.length >= 2) {
    const f = b.sort((p, w) => {
      if (p.u !== w.u) return p.u - w.u;
      const y = p.f.toLowerCase().trim(), D = w.f.toLowerCase().trim(), k = Ee, v = Ae, F = k.some((N) => y.includes(N)), _ = k.some((N) => D.includes(N)), L = v.some((N) => y.includes(N)), R = v.some((N) => D.includes(N));
      return l.info("DEBUG: Field comparison:", {
        aField: y,
        bField: D,
        aIsRow: F,
        bIsRow: _,
        aIsColumn: L,
        bIsColumn: R
      }), F && !_ ? -1 : _ && !F || L && !R ? 1 : R && !L ? -1 : y.localeCompare(D);
    });
    l.info(
      "DEBUG: Sorted candidates:",
      f.map((p) => ({ field: p.f, unique: p.u }))
    ), n = [
      { uniqueName: f[0].f, caption: f[0].f }
    ], o = [
      { uniqueName: f[1].f, caption: f[1].f }
    ], l.info(
    ...
    n = [
      { uniqueName: b[0].f, caption: b[0].f.trim() }
    ];
  else if (a.length >= 2) {
    const f = S.sort((p, w) => {
      if (p.u !== w.u) return p.u - w.u;
      const y = p.f.toLowerCase().trim(), D = w.f.toLowerCase().trim(), k = [
        "region",
        "country",
        "state",
        "city",
        ...
        "year",
        "type"
      ], F = k.some((N) => y.includes(N)), _ = k.some((N) => D.includes(N)), L = v.some((N) => y.includes(N)), R = v.some((N) => D.includes(N));
      return F && !_ ? -1 : _ && !F || L && !R ? 1 : R && !L ? -1 : y.localeCompare(D);
    });
    n = [
      {
        uniqueName: f[0].f,
    ...
    n = [{ uniqueName: S[0].f, caption: S[0].f.trim() }];
  if (!o || o.length === 0) {
    for (let f = 0; f < t.length; f++)
      t[f].__all__ = "All";
    o = [{ uniqueName: "__all__", caption: "All" }];
  }
  return {
    rows: n,
    columns: o,
    measures: i,
    data: t,
    columnsList: Object.keys(t[0] || {})
  };
}
var Z = 5e4;
var Y = 2e4;
function W(c) {
  const { file: e, engine: t, options: r, performanceModeOverride: s, parseTime: a } = c;
  let i = c.parsedData;
  const n = e.size > B, o = r.maxRecords ?? (n ? Y : Z), u = i.length;
  if (i.length > o && (l.warn(
    `⚠️ Dataset has ${u.toLocaleString()} rows. Loading first ${o.toLocaleString()} rows for performance.`
  ), i = i.slice(0, o)), i.length === 0)
    return {
      success: false,
      error: "No valid data found in file"
    };
  const d = Object.keys(i[0]), h = Ke(i, d);
  h.length > 0 && l.warn("Data validation warnings:", h), t.setAutoAllColumn(true);
  const g = Je(i), { rows: m, columns: C, measures: S, data: b } = g;
  t.updateDataSource(b), t.setLayout(m, C, S);
  try {
    "setConditionalFormatting" in t && typeof t.setConditionalFormatting == "function" && t.setConditionalFormatting([
      {
        value: {
          type: "Number",
  ...
  u > o && h.push(
    `Note: Displaying ${o.toLocaleString()} of ${u.toLocaleString()} rows for optimal performance.`
  );
  const f = s ?? z.getPerformanceMode(e.size, b.length), p = z.isDragDropAllowed(
    b.length
  ), w = z.requiresPagination(
    b.length
  );
  return p || l.info(
    `Large dataset detected: ${b.length.toLocaleString()} rows. Virtual scrolling will be used for optimal performance.`
  ), {
    success: true,
    data: b,
    fileName: e.name,
    ...
    columns: d,
    validationErrors: h.length > 0 ? h : void 0,
    performanceMode: f,
    allowDragDrop: p,
    requiresPagination: w,
    parseTime: a
  };
}
function Ze() {
...
var te = class te2 {
   ...
   */
  static async connectToLocalCSV(e, t = {}) {
    try {
      const r = await G(V);
      return r ? await this.processCSVFile(r, e, t) : { success: false, error: "No file selected" };
    } catch (r) {
      return l.error("Error connecting to CSV file:", r), {
        success: false,
   ...
   */
  static async connectToLocalJSON(e, t = {}) {
    try {
      const r = await G(H);
      return r ? await this.processJSONFile(r, e, t) : { success: false, error: "No file selected" };
    } catch (r) {
      return l.error("Error connecting to JSON file:", r), {
        success: false,
        error: r instanceof Error ? r.message : "Unknown error occurred"
      };
    }
   ...
   */
  static async connectToLocalFile(e, t = {}) {
    try {
      const r = [
        ...V,
        ...H
      ...
      const a = ge(s.name);
      return V.includes(a) ? await this.processCSVFile(s, e, t) : H.includes(a) ? await this.processJSONFile(s, e, t) : {
        success: false,
        error: `Unsupported file type: ${a}`
      };
    } catch (r) {
      return l.error("Error connecting to local file:", r), {
        success: false,
        error: r instanceof Error ? r.message : "Unknown error occurred"
      };
    }
   ...
   */
  static async processCSVFile(e, t, r) {
    const s = ne(e, r);
    if (!s.success)
      return s;
    if (e.size > q && T.isSupported()) {
      l.info(
        `🚀 Large file detected (${A(e.size)}). Using Streaming + WASM hybrid mode...`
      );
      try {
        const a = await this.processCSVFileWithStreamingWasm(
          e,
          t,
          r
        );
        if (a.success) return a;
        l.warn("⚠️ Streaming + WASM failed, falling back to Workers");
      } catch (a) {
        l.warn("⚠️ Streaming + WASM error:", a), l.warn("Falling back to Web Workers");
      }
    }
    if (e.size >= j && e.size <= q && T.isSupported()) {
      l.info(
        `🚀 Medium-large file detected (${A(e.size)}). Using WASM for maximum speed...`
      );
      try {
        const a = await this.processCSVFileWithWasm(
          e,
          t,
          r
        );
        if (a.success) return a;
        l.warn("⚠️ WASM processing failed, falling back to Workers");
      } catch (a) {
        l.warn("⚠️ WASM processing error:", a), l.warn("Falling back to Web Workers");
      }
    }
    if (e.size >= ue && r.useWorkers !== false)
      return l.info(
        `Medium file detected (${A(e.size)}). Using Web Workers for parallel processing.`
      ), this.processCSVFileWithWorkers(e, t, r);
    try {
      const a = {
        delimiter: ",",
        hasHeader: true,
        ...
        trimValues: true,
        ...r.csv
      }, i = await oe(e, r.onProgress), n = Ie(i, a), o = je(n);
      return W({
        file: e,
        parsedData: o,
        engine: t,
      ...
      return {
        success: false,
        error: `Failed to parse CSV file: ${a instanceof Error ? a.message : "Unknown error"}`
      };
    }
  }
  /**
   ...
   */
  static async processCSVFileWithWasm(e, t, r) {
    try {
      const s = {
        delimiter: ",",
        hasHeader: true,
      ...
      if (!await a.initialize())
        ...
        ), { success: false, error: "WASM initialization failed" };
      const n = await a.processFile(e, {
      ...
      }) : { success: false, error: "WASM processing failed" };
    } catch (s) {
      return l.error("WASM processing error:", s), {
        success: false,
        error: `WASM processing failed: ${s instanceof Error ? s.message : "Unknown error"}`
      };
    }
  }
  /**
   ...
   */
  static async processCSVFileWithStreamingWasm(e, t, r) {
    try {
      l.info("🚀 Using Streaming + WASM hybrid mode for large file...");
      const s = {
        delimiter: ",",
        hasHeader: true,
        skipEmptyLines: true,
      ...
      const n = e.size > B, o = r.maxRecords ?? (n ? Y : Z), u = [];
      let d, h = "", g = 0, m = 0;
      const C = $2.getOptimalChunkSize(e.size);
      l.info(
        `Processing with WASM, chunk size: ${A(C)}, max records: ${o.toLocaleString()}`
      );
      const S = performance.now(), b = new AbortController();
      await $2.readFileInChunks(e, {
        chunkSizeBytes: C,
        encoding: s.encoding,
        signal: b.signal,
        onProgress: (p) => {
        ...
        onChunk: async (p) => {
          ...
          const w = h + p.text;
          h = "";
          const y = await a.processCSV(w, {
            delimiter: s.delimiter,
            hasHeader: p.isFirstChunk && s.hasHeader,
            trimValues: s.trimValues,
            ...
            providedHeaders: !p.isFirstChunk && d ? d : void 0
          });
          if (!y.success || !y.data) {
            l.warn(
              `⚠️ WASM failed on chunk ${p.chunkId}, chunk skipped`
            );
            return;
          }
          if (p.isFirstChunk && y.data.length > 0 && (d = Object.keys(y.data[0]), l.info(`📋 Headers detected: ${d.join(", ")}`)), !p.isLastChunk) {
            const v = w.lastIndexOf(`
`);
            v !== -1 && (h = w.substring(v + 1), y.data.length > 0 && y.data.pop());
          }
          m += y.data.length;
          const D = o - u.length, k = y.data.length <= D ? y.data : y.data.slice(0, D);
          for (let v = 0; v < k.length; v++)
            u.push(k[v]);
          l.info(
            `Chunk ${p.chunkId} processed: ${y.data.length} rows (collected: ${u.length}/${o})`
          ), y.data = [], u.length >= o && (l.info(
            `✅ Reached record limit (${o.toLocaleString()}), stopping file read early.`
          ), b.abort());
        }
      });
      const f = performance.now() - S;
      return l.info(
        `✅ Streaming + WASM completed in ${(f / 1e3).toFixed(2)}s`
      ), l.info(
        `Processed ${g} chunks, ${m} rows parsed, ${u.length} rows collected.`
      ), r.onProgress && r.onProgress(90), W({
        file: e,
        parsedData: u,
        engine: t,
        options: r,
      ...
      return l.error("Error in Streaming + WASM processing:", s), {
        success: false,
        error: `Streaming + WASM failed: ${s instanceof Error ? s.message : "Unknown error"}`
      };
    }
  }
  /**
   ...
   */
  static async processCSVFileWithWorkers(e, t, r) {
    try {
      const s = {
        delimiter: ",",
        hasHeader: true,
      ...
      if (!this.workerPool) {
        const S = Ze(), b = new Blob([S], { type: "application/javascript" }), f = URL.createObjectURL(b);
        this.workerPool = new We(
          f,
          r.workerCount || Math.max(1, navigator.hardwareConcurrency - 1)
        );
      }
      const a = e.size > B, i = r.maxRecords ?? (a ? Y : Z), n = [];
      let o, u, d = 0;
      const h = r.chunkSizeBytes || $2.getOptimalChunkSize(e.size);
      l.info(
        `Processing with ${this.workerPool.getWorkerCount()} workers, chunk size: ${A(h)}, max records: ${i.toLocaleString()}`
      );
      const g = performance.now(), m = new AbortController();
      await $2.readFileInChunks(e, {
        chunkSizeBytes: h,
        encoding: s.encoding,
        signal: m.signal,
        ...
        onChunk: async (S) => {
          ...
          d++;
          const b = await this.workerPool.execute({
            type: "PARSE_CHUNK",
            chunkId: S.chunkId,
            text: S.text,
            isFirstChunk: S.isFirstChunk,
            isLastChunk: S.isLastChunk,
            delimiter: s.delimiter,
            headers: o,
            leftover: u
          });
          if (b.headers && (o = b.headers), u = b.leftover, b.data && b.data.length > 0) {
            const f = i - n.length, p = Math.min(b.data.length, f);
            for (let w = 0; w < p; w++)
              n.push(b.data[w]);
          }
          l.info(
            `Chunk ${S.chunkId} processed: ${b.rowCount} rows (collected: ${n.length}/${i})`
          ), n.length >= i && (l.info("✅ Reached record limit, stopping file read early."), m.abort());
        }
      });
      const C = performance.now() - g;
      return l.info(`Parsing completed in ${(C / 1e3).toFixed(2)}s`), l.info(
        `Streaming complete. Processed ${d} chunks, ${n.length} rows collected.`
      ), r.onProgress && r.onProgress(90), W({
        file: e,
        parsedData: n,
        engine: t,
      ...
      return l.error("Error in worker-based CSV processing:", s), {
        success: false,
        error: `Failed to parse CSV file: ${s instanceof Error ? s.message : "Unknown error"}`
      };
    }
  }
  /**
   ...
   */
  static async processJSONFile(e, t, r) {
    const s = ne(e, r);
    if (!s.success)
      return s;
    try {
      const a = await oe(e, r.onProgress), i = JSON.parse(a);
      let n = [];
      if (r.json?.arrayPath)
        n = Qe(i, r.json.arrayPath);
      else if (Array.isArray(i))
        n = i;
      else if (i.data && Array.isArray(i.data))
        n = i.data;
      else if (i.records && Array.isArray(i.records))
        n = i.records;
      else
        for (const o in i)
      ...
      return n.length === 0 ? {
        success: false,
        error: "No array data found in JSON file. Please ensure the file contains an array of objects."
      } : W({
        file: e,
        parsedData: n,
        engine: t,
      ...
      return a instanceof SyntaxError ? {
        success: false,
        error: "Invalid JSON format. Please check your file syntax."
      } : {
        success: false,
        error: `Failed to parse JSON file: ${a instanceof Error ? a.message : "Unknown error"}`
      };
    }
  }
  /**
   ...
   */
  static createImportSummary(e) {
    if (!e.success)
      return `Import failed: ${e.error}`;
    let t = `Successfully imported ${e.recordCount} records from ${e.fileName}`;
    return e.columns && (t += `
Columns: ${e.columns.join(", ")}`), e.fileSize && (t += `
File size: ${A(e.fileSize)}`), e.validationErrors && e.validationErrors.length > 0 && (t += `

Warnings:
${e.validationErrors.map((r) => `• ${r}`).join(`
`)}`), t;
  }
  /**
   * Shows a browser notification for import results
   */
  static showImportNotification(e) {
    const t = this.createImportSummary(e);
    if ("Notification" in window) {
      if (Notification.permission === "granted") {
        new Notification("PivotHead Import", { body: t });
        return;
      }
      if (Notification.permission !== "denied") {
        Notification.requestPermission().then((r) => {
          r === "granted" ? new Notification("PivotHead Import", { body: t }) : l.info(t);
        });
        return;
      }
    }
...
var rt = class {
  constructor(e) {
    this.scrollTop = 0, this.visibleStart = 0, this.visibleEnd = 0, this.containerHeight = 0, this.wrapper = null, this.spacer = null, this.content = null, this.resizeObserver = null, this.scrollRAF = null, this.container = e.container, this.data = e.data || [], this.rowHeight = e.rowHeight || Me, this.bufferSize = e.bufferSize || _e, this.renderRow = e.renderRow, this.renderHeader = e.renderHeader, this.onVisibleRangeChange = e.onVisibleRangeChange, this.onDragDrop = e.onDragDrop, this.init();
  }
  /**
  ...
  init() {
    if (!this.container) {
      l.error("VirtualScrollManager: Container not found");
      return;
    }
    this.wrapper = document.createElement("div"), this.wrapper.className = "virtual-scroller-wrapper", this.wrapper.style.cssText = `
      position: relative;
      overflow-y: auto;
      overflow-x: auto;
      height: 600px;
      border: 1px solid #dee2e6;
    `, this.spacer = document.createElement("div"), this.spacer.className = "virtual-scroller-spacer", this.spacer.style.cssText = `
      position: absolute;
      top: 0;
      left: 0;
      right: 0;
      pointer-events: none;
    `, this.content = document.createElement("div"), this.content.className = "virtual-scroller-content", this.content.style.cssText = `
      position: absolute;
      top: 0;
      left: 0;
      right: 0;
    `, this.wrapper.appendChild(this.spacer), this.wrapper.appendChild(this.content), this.container.appendChild(this.wrapper), this.wrapper.addEventListener("scroll", () => this.handleScroll()), this.resizeObserver = new ResizeObserver(() => {
      this.containerHeight = this.wrapper.clientHeight, this.render();
    }), this.resizeObserver.observe(this.wrapper), this.containerHeight = this.wrapper.clientHeight;
  }
  /**
   ...
   */
  handleScroll() {
    this.scrollRAF === null && (this.scrollRAF = requestAnimationFrame(() => {
      this.scrollRAF = null, this.onScroll();
    }));
  }
  /**
  ...
  onScroll() {
    ...
    const e = this.wrapper.scrollTop;
    Math.abs(e - this.scrollTop) > this.rowHeight / 2 && (this.scrollTop = e, this.render());
  }
  /**
   ...
   */
  getVisibleRange() {
    const e = Math.floor(this.scrollTop / this.rowHeight), t = Math.ceil(
      (this.scrollTop + this.containerHeight) / this.rowHeight
    ), r = Math.max(0, e - this.bufferSize), s = Math.min(this.data.length, t + this.bufferSize);
  ...
  render() {
    if (!this.data || this.data.length === 0 || !this.content || !this.spacer) {
      this.content && (this.content.innerHTML = '<div style="padding: 20px;">No data available</div>');
      return;
    }
    const { start: e, end: t } = this.getVisibleRange();
    this.visibleStart = e, this.visibleEnd = t, this.onVisibleRangeChange && this.onVisibleRangeChange(e, t);
    const r = this.data.length * this.rowHeight + Le;
    this.spacer.style.height = `${r}px`, this.content.innerHTML = "";
    ...
    a.style.transform = `translateY(${e * this.rowHeight}px)`;
    for (let i = e; i < t && !(i >= this.data.length); i++) {
      const n = this.renderRow(this.data[i], i);
      this.onDragDrop && this.addDragDropSupport(n, i), a.appendChild(n);
    }
   ...
   * @private
   */
  addDragDropSupport(e, t) {
    e.setAttribute("draggable", "true"), e.style.cursor = "move", e.dataset.virtualIndex = String(t), e.addEventListener("dragstart", (r) => {
      r.dataTransfer && (r.dataTransfer.effectAllowed = "move", r.dataTransfer.setData("text/plain", String(t))), e.style.opacity = "0.5";
      ...
      if (r.preventDefault(), r.dataTransfer && this.onDragDrop) {
        const s = parseInt(r.dataTransfer.getData("text/plain")), a = t;
        s !== a && this.onDragDrop(s, a);
      }
    });
  }
  /**
   ...
   */
  setData(e) {
    this.data = e, this.scrollTop = 0, this.wrapper && (this.wrapper.scrollTop = 0), this.render();
  }
  /**
   * Update row height
  ...
  scrollToIndex(e) {
    ...
    this.wrapper.scrollTop = t, this.scrollTop = t, this.render();
  }
  /**
   * Scroll to the top
   */
   ...
   */
  mount(e) {
    this.wrapper && (e.innerHTML = "", e.appendChild(this.wrapper), this.render());
  }
  /**
   ...
   */
  destroy() {
    this.scrollRAF !== null && (cancelAnimationFrame(this.scrollRAF), this.scrollRAF = null), this.resizeObserver && (this.resizeObserver.disconnect(), this.resizeObserver = null), this.wrapper && this.wrapper.parentElement && this.wrapper.parentElement.removeChild(this.wrapper), this.wrapper = null, this.spacer = null, this.content = null, this.data = [];
  }
};
export {
  le as ConnectService,
  tt as FieldService,
  z as PerformanceConfig,
  et as PivotEngine,
  rt as VirtualScrollManager,
  T as WasmLoader,
  He as getWasmLoader
};
//# sourceMappingURL=@mindfiredigital_pivothead.js.map
