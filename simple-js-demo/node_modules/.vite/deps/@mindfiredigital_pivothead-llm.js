...
// node_modules/@mindfiredigital/pivothead-llm/dist/index.js
var ModelManager = class {
  ...
  async load(modelId, onProgress) {
    ...
    const { CreateMLCEngine } = await import("./lib-33EBUMXZ.js");
      ...
      pivotEngine: {
        ...
        setAggregation: (field, func) => {
          ...
          if (relevantEntries.length > 0) {
            ...
            const groupLabel = colField ? `${rowField} × ${colField}` : rowField;
            onMessage(
              "assistant",
...
//# sourceMappingURL=@mindfiredigital_pivothead-llm.js.map
