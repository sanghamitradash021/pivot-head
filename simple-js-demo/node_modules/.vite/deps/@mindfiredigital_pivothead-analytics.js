...
// node_modules/@mindfiredigital/pivothead-analytics/dist/index.js
...
var _CanvasFunnelInstance = class _CanvasFunnelInstance2 {
  constructor(canvas, data, options) {
    this.resizeObserver = null;
    this.canvas = canvas;
    this.data = data;
  ...
  draw() {
    ...
    const paletteColors = this.options.style?.colors || _CanvasFunnelInstance2.DEFAULT_COLORS;
...
function getPlotly(injected) {
  ...
  try {
    return __require2("plotly.js-dist");
  } catch {
    try {
      return __require2("plotly.js");
    } catch {
      throw new Error(
...
<svg xmlns="http://www.w3.org/2000/svg"
  ...
  static async exportPdf(canvas, options = {}) {
    try {
      const { jsPDF } = await import("./jspdf.es.min-LVDMTJZW.js");
      const width = options.width || canvas.width;
      const height = options.height || canvas.height;
...
function buildWinstonLogger() {
  ...
  try {
    const winston = __require2("winston");
...
//# sourceMappingURL=@mindfiredigital_pivothead-analytics.js.map
