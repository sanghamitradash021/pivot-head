...
function getPlotly(injected) {
  ...
  try {
    return __require("plotly.js-dist");
  } catch {
    try {
      return __require("plotly.js");
    } catch {
      throw new Error(
